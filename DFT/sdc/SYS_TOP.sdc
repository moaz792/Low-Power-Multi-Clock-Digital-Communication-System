...
# Created by write_sdc on Wed Oct 1 23:24:15 2025
...
create_clock [get_ports scan_clk]  -period 20  -waveform {0 10}
...
set_input_delay -clock scan_clk  4  [get_ports SI]
...
set_output_delay -clock scan_clk  4  [get_ports SO]
...
set_clock_groups -asynchronous -name uart_clk_2 -group [list [get_clocks uart_clk] [get_clocks rx_clk] [get_clocks tx_clk]] -group [list [get_clocks ref_clk] [get_clocks Gated_Clock]]
set_clock_groups -asynchronous -name scan_clk_1 -group [get_clocks scan_clk] -group [list [get_clocks ref_clk] [get_clocks Gated_Clock]]
set_clock_groups -asynchronous -name uart_clk_3 -group [list [get_clocks uart_clk] [get_clocks rx_clk] [get_clocks tx_clk]] -group [get_clocks scan_clk]
